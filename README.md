...
6. Добавьте read-only API-ключи Binance Futures, если хотите автоматическое создание клипов по закрытым сделкам.
7. Нажмите `Создать тестовый клип`, чтобы проверить встроенный replay-буфер и ffmpeg-нарезку.
