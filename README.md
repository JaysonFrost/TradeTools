  ...
  <tr>
    <td valign="top">
      <ul>
        ...
        <li>Автоматически видит сделки Vataga по локальным логам терминала, без API-ключей биржи.</li>
...
7. Перед торговлей оставьте TradeTools и Vataga открытыми: после закрытия позиции клип будет создан автоматически.
