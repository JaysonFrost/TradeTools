...
4. Нажмите `Настройка видео` и пройдите мастер.
...
На странице `Прокси` можно добавить свои серверы, перетащить их в нужном порядке и нажать `Настроить и запустить`. TradeTools подключится по SSH, установит Xray, свяжет серверы в маршрут и покажет, что указать в торговом терминале.
